...
deletedOn                                timestamp,
constraint                               ck_status_OutletTransactionProfile                          check          (status = 'Active' or status = 'Inactive' or status = 'Closed' or status = 'Deleted'),
constraint                               ck_isApproverRemarks_OutletTransactionProfile               check          (isApproverRemarks = 'Yes' or isApproverRemarks = 'No'),
constraint                               ck_isNewRecord_OutletTransactionProfile                     check          (isNewRecord = 'Yes' or isNewRecord = 'No')
);
