...
constraint                               pk_OutletTransactionProfileHistory                          primary key    (oid),
constraint                               ck_tpType_OutletTransactionProfileHistory                   check          (tpType = 'Default' or tpType = 'Specific' or tpType = 'NotDefined'),
constraint                               ck_enabledMaxNoCashTrnPerDay_OutletTransactionProfileHistorycheck          (enabledMaxNoCashTrnPerDay = 'Yes' or enabledMaxNoCashTrnPerDay = 'No'),
constraint                               ck_enabledMaxNoCashTrnPerWeek_OutletTransactionProfileHistorycheck          (enabledMaxNoCashTrnPerWeek = 'Yes' or enabledMaxNoCashTrnPerWeek = 'No'),
constraint                               ck_enabledMaxNoCashTrnPerMonth_OutletTransactionProfileHistorycheck          (enabledMaxNoCashTrnPerMonth = 'Yes' or enabledMaxNoCashTrnPerMonth = 'No'),
constraint                               ck_enabledMaxCashTrnPerDay_OutletTransactionProfileHistory  check          (enabledMaxCashTrnPerDay = 'Yes' or enabledMaxCashTrnPerDay = 'No'),
constraint                               ck_enabledMaxCashTrnPerWeek_OutletTransactionProfileHistory check          (enabledMaxCashTrnPerWeek = 'Yes' or enabledMaxCashTrnPerWeek = 'No'),
constraint                               ck_enabledMaxCashTrnPerMonth_OutletTransactionProfileHistorycheck          (enabledMaxCashTrnPerMonth = 'Yes' or enabledMaxCashTrnPerMonth = 'No'),
constraint                               ck_enabledMaxDpPerTrn_OutletTransactionProfileHistory       check          (enabledMaxDpPerTrn = 'Yes' or enabledMaxDpPerTrn = 'No'),
constraint                               ck_enabledMaxDpPerDay_OutletTransactionProfileHistory       check          (enabledMaxDpPerDay = 'Yes' or enabledMaxDpPerDay = 'No'),
constraint                               ck_enabledMaxDpPerWeek_OutletTransactionProfileHistory      check          (enabledMaxDpPerWeek = 'Yes' or enabledMaxDpPerWeek = 'No'),
constraint                               ck_enabledMaxDpPerMonth_OutletTransactionProfileHistory     check          (enabledMaxDpPerMonth = 'Yes' or enabledMaxDpPerMonth = 'No'),
constraint                               ck_enabledMaxWdPerTrn_OutletTransactionProfileHistory       check          (enabledMaxWdPerTrn = 'Yes' or enabledMaxWdPerTrn = 'No'),
constraint                               ck_enabledMaxWdPerDay_OutletTransactionProfileHistory       check          (enabledMaxWdPerDay = 'Yes' or enabledMaxWdPerDay = 'No'),
constraint                               ck_enabledMaxWdPerWeek_OutletTransactionProfileHistory      check          (enabledMaxWdPerWeek = 'Yes' or enabledMaxWdPerWeek = 'No'),
constraint                               ck_enabledMaxWdPerMonth_OutletTransactionProfileHistory     check          (enabledMaxWdPerMonth = 'Yes' or enabledMaxWdPerMonth = 'No'),
constraint                               ck_enabledMaxFdPerTrn_OutletTransactionProfileHistory       check          (enabledMaxFdPerTrn = 'Yes' or enabledMaxFdPerTrn = 'No'),
constraint                               ck_enabledMaxFdPerDay_OutletTransactionProfileHistory       check          (enabledMaxFdPerDay = 'Yes' or enabledMaxFdPerDay = 'No'),
constraint                               ck_enabledMaxFdPerWeek_OutletTransactionProfileHistory      check          (enabledMaxFdPerWeek = 'Yes' or enabledMaxFdPerWeek = 'No'),
constraint                               ck_enabledMaxFdPerMonth_OutletTransactionProfileHistory     check          (enabledMaxFdPerMonth = 'Yes' or enabledMaxFdPerMonth = 'No'),
constraint                               ck_enabledMaxNoFdPerDay_OutletTransactionProfileHistory     check          (enabledMaxNoFdPerDay = 'Yes' or enabledMaxNoFdPerDay = 'No'),
constraint                               ck_enabledMaxNoFdPerWeek_OutletTransactionProfileHistory    check          (enabledMaxNoFdPerWeek = 'Yes' or enabledMaxNoFdPerWeek = 'No'),
constraint                               ck_enabledMaxNoFdPerMonth_OutletTransactionProfileHistory   check          (enabledMaxNoFdPerMonth = 'Yes' or enabledMaxNoFdPerMonth = 'No'),
constraint                               ck_enabledMinBalance_OutletTransactionProfileHistory        check          (enabledMinBalance = 'Yes' or enabledMinBalance = 'No'),
constraint                               ck_enabledMaxBalance_OutletTransactionProfileHistory        check          (enabledMaxBalance = 'Yes' or enabledMaxBalance = 'No')
);
