...
constraint                               pk_UnAuthOutletTransactionProfile                           primary key    (oid),
constraint                               ck_tpType_UnAuthOutletTransactionProfile                    check          (tpType = 'Default' or tpType = 'Specific' or tpType = 'NotDefined'),
constraint                               ck_enabledMaxNoCashTrnPerDay_UnAuthOutletTransactionProfile check          (enabledMaxNoCashTrnPerDay = 'Yes' or enabledMaxNoCashTrnPerDay = 'No'),
constraint                               ck_enabledMaxNoCashTrnPerWeek_UnAuthOutletTransactionProfilecheck          (enabledMaxNoCashTrnPerWeek = 'Yes' or enabledMaxNoCashTrnPerWeek = 'No'),
constraint                               ck_enabledMaxNoCashTrnPerMonth_UnAuthOutletTransactionProfilecheck          (enabledMaxNoCashTrnPerMonth = 'Yes' or enabledMaxNoCashTrnPerMonth = 'No'),
constraint                               ck_enabledMaxCashTrnPerDay_UnAuthOutletTransactionProfile   check          (enabledMaxCashTrnPerDay = 'Yes' or enabledMaxCashTrnPerDay = 'No'),
constraint                               ck_enabledMaxCashTrnPerWeek_UnAuthOutletTransactionProfile  check          (enabledMaxCashTrnPerWeek = 'Yes' or enabledMaxCashTrnPerWeek = 'No'),
constraint                               ck_enabledMaxCashTrnPerMonth_UnAuthOutletTransactionProfile check          (enabledMaxCashTrnPerMonth = 'Yes' or enabledMaxCashTrnPerMonth = 'No'),
constraint                               ck_enabledMaxDpPerTrn_UnAuthOutletTransactionProfile        check          (enabledMaxDpPerTrn = 'Yes' or enabledMaxDpPerTrn = 'No'),
constraint                               ck_enabledMaxDpPerDay_UnAuthOutletTransactionProfile        check          (enabledMaxDpPerDay = 'Yes' or enabledMaxDpPerDay = 'No'),
constraint                               ck_enabledMaxDpPerWeek_UnAuthOutletTransactionProfile       check          (enabledMaxDpPerWeek = 'Yes' or enabledMaxDpPerWeek = 'No'),
constraint                               ck_enabledMaxDpPerMonth_UnAuthOutletTransactionProfile      check          (enabledMaxDpPerMonth = 'Yes' or enabledMaxDpPerMonth = 'No'),
constraint                               ck_enabledMaxWdPerTrn_UnAuthOutletTransactionProfile        check          (enabledMaxWdPerTrn = 'Yes' or enabledMaxWdPerTrn = 'No'),
constraint                               ck_enabledMaxWdPerDay_UnAuthOutletTransactionProfile        check          (enabledMaxWdPerDay = 'Yes' or enabledMaxWdPerDay = 'No'),
constraint                               ck_enabledMaxWdPerWeek_UnAuthOutletTransactionProfile       check          (enabledMaxWdPerWeek = 'Yes' or enabledMaxWdPerWeek = 'No'),
constraint                               ck_enabledMaxWdPerMonth_UnAuthOutletTransactionProfile      check          (enabledMaxWdPerMonth = 'Yes' or enabledMaxWdPerMonth = 'No'),
constraint                               ck_enabledMaxFdPerTrn_UnAuthOutletTransactionProfile        check          (enabledMaxFdPerTrn = 'Yes' or enabledMaxFdPerTrn = 'No'),
constraint                               ck_enabledMaxFdPerDay_UnAuthOutletTransactionProfile        check          (enabledMaxFdPerDay = 'Yes' or enabledMaxFdPerDay = 'No'),
constraint                               ck_enabledMaxFdPerWeek_UnAuthOutletTransactionProfile       check          (enabledMaxFdPerWeek = 'Yes' or enabledMaxFdPerWeek = 'No'),
constraint                               ck_enabledMaxFdPerMonth_UnAuthOutletTransactionProfile      check          (enabledMaxFdPerMonth = 'Yes' or enabledMaxFdPerMonth = 'No'),
constraint                               ck_enabledMaxNoFdPerDay_UnAuthOutletTransactionProfile      check          (enabledMaxNoFdPerDay = 'Yes' or enabledMaxNoFdPerDay = 'No'),
constraint                               ck_enabledMaxNoFdPerWeek_UnAuthOutletTransactionProfile     check          (enabledMaxNoFdPerWeek = 'Yes' or enabledMaxNoFdPerWeek = 'No'),
constraint                               ck_enabledMaxNoFdPerMonth_UnAuthOutletTransactionProfile    check          (enabledMaxNoFdPerMonth = 'Yes' or enabledMaxNoFdPerMonth = 'No'),
constraint                               ck_enabledMinBalance_UnAuthOutletTransactionProfile         check          (enabledMinBalance = 'Yes' or enabledMinBalance = 'No'),
constraint                               ck_enabledMaxBalance_UnAuthOutletTransactionProfile         check          (enabledMaxBalance = 'Yes' or enabledMaxBalance = 'No')
);
