...
*/
create table                             ParribahanSourceDestination
(
...
updatedOn                                timestamp,
constraint                               pk_ParribahanSourceDestination                              primary key    (oid),
constraint                               u_locationId_ParribahanSourceDestination                    unique         (locationId)
);
