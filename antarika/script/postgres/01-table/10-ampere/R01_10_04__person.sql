...
This table is used to store person fingerprint nformation
oid                                      : Surrogate primary key
personFingerprintOid                     : Parent Table PersonFingerprint oid
identifiyerId                            : A PersonFingerprint associated with system to be identified by 
fpDeviceOid                              : Parent table FpDevice oid
fpDeviceModelOid                         : Parent table FpDeviceModel oid
fpDeviceMnemonic                         : Fingerprint device Mnemonic
...
updatedOn                                : When the record was last updated
*/
create table                             PersonFingerprintHistory
(
oid                                      varchar(128)                                                not null,
...
updatedBy                                varchar(128),
updatedOn                                timestamp,
constraint                               pk_PersonFingerprintHistory                                 primary key    (oid),
constraint                               fk_personFingerprintOid_PersonFingerprintHistory            foreign key    (personFingerprintOid)
                                                                                                     references     PersonFingerprint(oid),
constraint                               fk_fpDeviceOid_PersonFingerprintHistory                     foreign key    (fpDeviceOid)
                                                                                                     references     FpDevice(oid),
constraint                               fk_fpDeviceModelOid_PersonFingerprintHistory                foreign key    (fpDeviceModelOid)
                                                                                                     references     FpDeviceModel(oid)
);
...
This table is used to store person fingerprint log info
oid                                      : Surrogate primary key
loginId                                  : A PersonFingerprintLog associated with system to be identified by 
personOid                                : A PersonFingerprintLog associated with system to be identified by 
fpEnrolled                               : A PersonFingerprint associated with system to be identified by 
capturedPhoto                            : A PersonFingerprint associated with system to be identified by 
imageVerified                            : Changed from finger
otp                                      : Changed to finger
otpExpireTime                            : Reason for change
otpVerified                              : Application date
status                                   : Associated status: Active, Inactive, Made, Approved, Edit, Rejected, Closed, Canceled
createdBy                                : Who (which login) created the record
createdOn                                : When the record was created
...
*/
create table                             FpEnrollmentRequest
(
oid                                      varchar(128)                                                not null,
loginId                                  varchar(128)                                                not null,
personOid                                varchar(128)                                                not null,
fpEnrolled                               varchar(8)                                                  not null,
capturedPhoto                            text,
imageVerified                            varchar(8)                                                                 default 'No',
otp                                      varchar(128),
otpExpireTime                            timestamp,
otpVerified                              varchar(8)                                                                 default 'No',
status                                   varchar(32)                                                                default 'Submitted',
createdBy                                varchar(128)                                                not null       default 'System',
createdOn                                timestamp                                                   not null       default current_timestamp,
editedBy                                 varchar(128),
editedOn                                 timestamp,
constraint                               fk_personOid_FpEnrollmentRequest                            foreign key    (personOid)
                                                                                                     references     Person(oid),
constraint                               ck_fpEnrolled_FpEnrollmentRequest                           check          (fpEnrolled = 'Yes' or fpEnrolled = 'No'),
constraint                               ck_imageVerified_FpEnrollmentRequest                        check          (imageVerified = 'Yes' or imageVerified = 'No'),
constraint                               ck_otpVerified_FpEnrollmentRequest                          check          (otpVerified = 'Yes' or otpVerified = 'No'),
constraint                               ck_status_FpEnrollmentRequest                               check          (status = 'Submitted' or status = 'ImageVerified' or status = 'OtpSent' or status = 'OtpVerified' or status = 'FpEnrolled')
);
