...
deletedOn                                timestamp,
deletionRemark                           text,
constraint                               pk_UnauthMenuConfig                                         primary key    (oid),
constraint                               ck_status_UnauthMenuConfig                                  check          (status = 'Active' or status = 'Inactive' or status = 'Closed' or status = 'Deleted'),
constraint                               ck_editcommit_UnauthMenuConfig                              check          (editcommit = 'Yes' or editcommit = 'No'),
constraint                               ck_isApproverRemarks_UnauthMenuConfig                       check          (isApproverRemarks = 'Yes' or isApproverRemarks = 'No'),
constraint                               ck_isNewRecord_UnauthMenuConfig                             check          (isNewRecord = 'Yes' or isNewRecord = 'No')
);
