package net.celloscope.antarika.postgres.genericfunction.v2.dao;
...
@Slf4j
@Repository("postgresGenericFunctionV2ExecuteFunctionDao")
public class ExecuteFunctionDao {
	...
	public Object executeFunction(String functionName,   Object[] args) throws AppException {
		log.debug("Function name : {}, args : {}", functionName, Arrays.deepToString(args));
		try {
