...
@Slf4j
@Repository("postgresGenericInsertV1InsertSingleDao")
public class InsertSingleDao {
	
	@Autowired
	@Qualifier("baseDao")
	private BaseDao baseDao;

	public int insertData(String sql, Object[] args) throws AppException {
		log.debug("Insert query : {}, param : {}", sql, Arrays.deepToString(args));
		try {
