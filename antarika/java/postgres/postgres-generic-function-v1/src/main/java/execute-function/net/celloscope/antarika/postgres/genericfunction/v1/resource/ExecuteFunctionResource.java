package net.celloscope.antarika.postgres.genericfunction.v1.resource;
...
import net.celloscope.antarika.postgres.genericfunction.v1.response.ExecuteFunctionResponseBody;
...
@Slf4j
@Component("postgresGenericFunctionV1ExecuteFunctionResource")
@Path(Api.POSTGRES_GENERIC_FUNCTION_V1_PATH)
public class ExecuteFunctionResource {

	private final String REQUEST_VERSION = "1.0";
	
	@Autowired
	@Qualifier("postgresGenericFunctionV1ExecuteFunctionService")
	...
	@RolesAllowed(Api.POSTGRES_GENERIC_FUNCTION_V1_PATH+Api.FUNCTION_RESOURCE_PATH)
	public ExecuteFunctionResponse onPost(@Auth User user, @HeaderParam("requestReceivedTime") long requestReceivedTime, @Valid ExecuteFunctionRequest request) {
		String url = Api.POSTGRES_GENERIC_FUNCTION_V1_PATH.concat(Api.FUNCTION_RESOURCE_PATH);
